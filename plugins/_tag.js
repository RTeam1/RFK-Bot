...
let gw = '6289677763976@s.whatsapp.net'
    ...
    try {
        ...
        //await this.sendMessage(m.chat, './tag.webp', MessageType.sticker, {
      //quoted: m, contextInfo:{externalAdReply: {title: run, body: 'Simple WhatsApp Bot', sourceUrl: linkf, thumbnail: thumb3}}
    //})
            await this.sendFile(m.chat, './tag.webp', 'tag.webp', '', m, false, {contextInfo:{externalAdReply: {title: run, body: 'Simple WhatsApp Bot', sourceUrl: linkf, thumbnail: thumb3}}}
            )
        }
    } catch (e) {
        return
