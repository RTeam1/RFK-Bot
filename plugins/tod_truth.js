...
let handler = async (m, { text, usedPrefix, command }) => {
  await conn.sendButton(m.chat, `“${pickRandom(global.truth)}”`, footer, 'Truth', `${usedPrefix + command}`, m)
}
handler.help = ['truth']
handler.tags = ['fun']
...
global.truth = [
    ...
    "siapa orang yang paling berpengharuh kepada kehidupanmu",
    ...
    "suka mabar(main bareng) sama siapa aja?", 
