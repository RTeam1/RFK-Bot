...
let handler = async (m, { text, usedPrefix, command }) => {
  await conn.sendButton(m.chat, `“${pickRandom(global.dare)}”`, footer, 'Dare', `${usedPrefix + command}`, m)
}
handler.help = ['dare']
handler.tags = ['fun']
...
global.dare = [
    ...
    "Bilang ke random people  _Aku baru saja diberi tahu aku adalah kembaranmu dulu, kita dipisahkan, lalu aku menjalani operasi plastik. Dan ini adalah hal paling ciyussss_",
